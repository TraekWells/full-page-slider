...
(function() {
  ...
  const nextPlanetName = document.querySelector(
    ".slider__controls-next-planet"
  );
  const planetIndicatorContainer = document.querySelector(
    ".slider__indicators"
  );
  const planetIndicators = Array.from(
    document.querySelectorAll(".slider__indicators span")
  );
  let currentSlide = 0;
